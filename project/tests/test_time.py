...
class TestFPSCounter:
    ...
    def test_get_fps_with_history(self):
    ...
    def test_target_fps_no_sleep(self):
    ...
    def test_target_fps_with_sleep(self):
...
class TestTimeFeeder:
    ...
    def test_tick_single_step(self):
    ...
    def test_tick_multiple_steps(self):
    ...
    def test_no_lag_when_caught_up(self):
