...
class TestConsoleService:
    ...
    def test_get_all_buffer_empty(self, console_service: ConsoleService) -> None:
        """Test get_all_buffer with empty input."""
        buffer = console_service.get_all_buffer()
        assert buffer == ">>> "

    def test_get_buffer_start_empty(self, console_service: ConsoleService) -> None:
        """Test get_buffer_start with empty input."""
        buffer = console_service.get_buffer_start()
        assert buffer == ">>> "

    def test_get_buffer_end_empty(self, console_service: ConsoleService) -> None:
        """Test get_buffer_end with empty input."""
        buffer = console_service.get_buffer_end()
        assert buffer == ""

    def test_enter_text(self, console_service: ConsoleService) -> None:
        """Test entering text."""
        console_service.enter_text("hello")
        assert console_service.input_buffer == "hello"
        assert console_service.input_index == 5

    def test_enter_text_multiple(self, console_service: ConsoleService) -> None:
    ...
    def test_enter_text_at_position(self, console_service: ConsoleService) -> None:
    ...
    def test_get_buffer_with_text(self, console_service: ConsoleService) -> None:
    ...
    def test_press_backspace(self, console_service: ConsoleService) -> None:
        """Test backspace."""
        console_service.enter_text("hello")
    ...
    def test_press_backspace_multiple(self, console_service: ConsoleService) -> None:
    ...
    def test_press_backspace_at_start(self, console_service: ConsoleService) -> None:
    ...
    def test_press_backspace_in_middle(self, console_service: ConsoleService) -> None:
    ...
    def test_press_delete(self, console_service: ConsoleService) -> None:
        """Test delete."""
        console_service.enter_text("hello")
        console_service.input_index = 0
    ...
    def test_press_delete_multiple(self, console_service: ConsoleService) -> None:
    ...
    def test_press_delete_at_end(self, console_service: ConsoleService) -> None:
    ...
    def test_press_delete_in_middle(self, console_service: ConsoleService) -> None:
    ...
    def test_press_left(self, console_service: ConsoleService) -> None:
        """Test left arrow key."""
        console_service.enter_text("hello")
        console_service.press_left()
        assert console_service.input_index == 4

    def test_press_left_multiple(self, console_service: ConsoleService) -> None:
        """Test left arrow key with amount."""
        console_service.enter_text("hello")
        console_service.press_left(3)
        assert console_service.input_index == 2

    def test_press_left_at_start(self, console_service: ConsoleService) -> None:
    ...
    def test_press_right(self, console_service: ConsoleService) -> None:
    ...
    def test_press_right_multiple(self, console_service: ConsoleService) -> None:
    ...
    def test_press_right_at_end(self, console_service: ConsoleService) -> None:
        """Test right arrow key at end."""
        console_service.enter_text("hello")
        console_service.press_right()
        assert console_service.input_index == 5

    def test_press_home(self, console_service: ConsoleService) -> None:
        """Test home key."""
        console_service.enter_text("hello")
        console_service.press_home()
        assert console_service.input_index == 0

    def test_press_end(self, console_service: ConsoleService) -> None:
        """Test end key."""
        console_service.enter_text("hello")
        console_service.input_index = 0
    ...
    def test_press_enter(self, console_service: ConsoleService) -> None:
        """Test enter key."""
    ...
    def test_press_enter_empty(self, console_service: ConsoleService) -> None:
        """Test enter key with empty input."""
        console_service.press_enter()
        assert console_service.input_buffer == ""
        assert console_service.history == []

    def test_press_enter_multiline(self, console_service: ConsoleService) -> None:
        """Test enter key starts multiline mode."""
        console_service.enter_text("def foo():")
        console_service.press_enter()
        assert console_service.prompt == "... "

    def test_press_enter_completes_multiline(
    ...
    def test_enter_text_exits_history(self, console_service: ConsoleService) -> None:
    ...
    def test_press_enter_uses_history_selection(
        self, console_service: ConsoleService
    ) -> None:
    ...
    def test_cursor_movement_sequence(self, console_service: ConsoleService) -> None:
    ...
    def test_editing_sequence(self, console_service: ConsoleService) -> None:
