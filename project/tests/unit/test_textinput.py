...
class TestTextInput:
    def test_initialization(self) -> None:
        ...
        assert text_input.color == (0, 0, 0, 255)
...
class TestTextInputSubmit:
    ...
    def test_press_enter_without_callback(self) -> None:
        ...
        text_input.on_enter(MagicMock())  # Should not raise
